# Carrus — User Stories & High-Level Requirements

## High-Level Requirements

### Primary Customer User Story
- **HLR-C-01:** As a customer, I want to search and compare available vehicles from supported rental companies and peer-to-peer marketplaces by location, rental dates, make/model, search radius, and total estimated cost, so I can select the rental that best fits my needs and continue to the provider without searching multiple websites separately.
...
- **HLR-P-01:** As a partner, I want a "verified" status so my vehicles are eligible to be rented through the Carrus marketplace.
- **HLR-P-02:** As a partner, I want to manage vehicle availability and approve reservation requests so my vehicles aren't double-booked.
- **HLR-P-03:** As a partner, I want to document vehicle condition at pickup and return so additional charges and disputes are handled fairly.

### Administrative User Stories
- **HLR-A-01:** As an administrator, I want to verify rental partners and vehicle listings so customers can rent from trustworthy providers and know they're receiving the product actually advertised.
- **HLR-A-02:** As an administrator, I want to review disputes and suspend fraudulent or unsafe accounts so Carrus remains a fair and secure marketplace.
- **HLR-A-03:** As an administrator, I want to manage partner payments and review transaction reports so payments are accurate and business activity is properly recorded.
...
- **US-P-07:** As a partner, I want to assess cleanliness and fuel level at return and apply a fee only when it crosses a clear, predefined threshold, so charges are consistent and justified rather than arbitrary.
